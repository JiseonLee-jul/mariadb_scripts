...
SELECT
    ...
    COUNT(CASE WHEN d.dept_name = 'ACCOUTING' THEN 1 END) AS 'ACCOUTING',
...
SELECT 
    ...
    CASE WHEN d.dept_name = 'ACCOUTING' THEN count END AS 'ACCOUTING',
...
SELECT 
    ...
    SUM(CASE WHEN d.dept_name = 'ACCOUTING' THEN count END) AS 'ACCOUTING',
