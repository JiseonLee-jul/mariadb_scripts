...
(5,'부서','500','유통\r'),
(6,'고객등급','MS001','GOLD\r'),
(7,'고객등급','MS002','SILVER\r'),
(8,'고객등급','MS003','BRONZE\r'),
(9,'고객등급','MS004','FAMILY\r'),
(10,'상품구분','F','음식\r'),
(11,'상품구분','E','전자제품\r'),
(12,'상품구분','A','사무용품\r'),
(13,'상품구분','C','화장품\r'),
...
CREATE TABLE `purchase` (
  `prchs_no` int(11) NOT NULL,
  `cstmr_no` int(11) NOT NULL,
  `goods_no` int(11) NOT NULL,
  `purchs_no` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-11-28 12:13:48
